              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-blue-600 dark:text-blue-400 flex items-center">
                    <Tk_icon size={16} className="mr-1" />{shippingMethod.price}
                  </p>
                </div>
              </div>
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex-1 min-w-0 pr-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <p className="text-lg font-bold text-blue-600 dark:text-blue-400 ml-2 flex items-center">
              <Tk_icon size={16} className="mr-1" />{method.price}
            </p>
          </div>
        </div>
      </div>
...
// Main Shipping Method Selector Component
      ...
      >
        {shippingMethods.map((method) => (
          <ShippingMethodCard
            key={method.id}
            method={method}
            isSelected={selectedMethodId ? selectedMethodId === method.id : selectedMethod?.id === method.id}
